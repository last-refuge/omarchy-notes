...
> [!WARNING]
> **This is an early preview.** Writing and editing work well, and saving is solid. But deleting notes, search and folders don't exist yet. Every note you create stays in your list for now. Check the [roadmap](#-roadmap) for what's coming.
...
Everything is stored in `~/.local/share/omarchy-notes/`: an SQLite database for your notes, plus a folder of attached files. Reinstalling or removing the app never touches it, so to back up, just copy that folder.
...
| 📅 | **Local beta** | Tags, Smart Folders, gallery view, import/export, Quick Note |
